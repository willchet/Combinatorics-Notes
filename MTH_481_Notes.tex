...
\begin{lemma}
$f_{n+2}-1=f_n+\cdots+f_0$

\begin{hl}
\begin{proof}
LHS counts number of ways to tile a $1\times(n+2)$ grid with at least one domino. RHS conditions on the number of tiles to the left of the rightmost domino.
\end{proof}
\end{hl}
\end{lemma}
